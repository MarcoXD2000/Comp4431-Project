(function(imageproc) {
    ...
    imageproc.comicColor = function(inputData, outputData, saturation) {
        ...
        for (var i = 0; i < inputData.data.length; i += 4) {
            ...
            let hsvValues = imageproc.fromRGBToHSV(r, g, b);
            var h = hsvValues.h;
            var s = hsvValues.s;
            s *= saturation;
            var v = hsvValues.v;
            if (s > 1) s = 1;
            let rgbValues = imageproc.fromHSVToRGB(h, s, v);
            ...
            r = palette[closestPalette][0];
            g = palette[closestPalette][1];
            b = palette[closestPalette][2];
